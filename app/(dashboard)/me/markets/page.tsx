/**
 * User markets page: displays user's followed markets and browse-to-follow flow.
 * Fetches user's sites server-side; markets loaded client-side via API.
 */
...
export default async function MeMarketsPage() {
  ...
  return <MeMarketsPageContent sites={sites.map(toPublicSite)} />;
}
